...
/**
 * Servlet implementation class ApartmentAddCheckServlet
 */
@WebServlet("/account/apartmentaddcheck")
public class ApartmentAddCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApartmentAddCheckServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd =request.getRequestDispatcher("/account/apartment_add_check.jsp");
