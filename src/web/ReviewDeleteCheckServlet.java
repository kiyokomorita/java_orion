...
/**
 * Servlet implementation class ReviewDeleteCheckServlet
 */
@WebServlet("/account/reviewdeletecheck")
public class ReviewDeleteCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewDeleteCheckServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//確認画面へフォワード
		RequestDispatcher rd = request.getRequestDispatcher("/account/review_delete_check.jsp");
