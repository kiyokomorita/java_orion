...
<div class="apartment_search_form_inwrap">
...
</div><!-- //apartment_search_form_inwrap -->

<button type="submit" name="submit" class="btn btn-warning btn_half_left">物件検索</button>
<button formaction="/Orion/apartmentsearch" class="btn btn-default btn_half_right">リセット</button>
</form>
