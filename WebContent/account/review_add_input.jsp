...
<div class="title_wrap">口コミ新規登録：入力画面</div>

<div id="table_common_wrap">
<form id="review_add_input_check" action="reviewaddcheck" method="post">
...
<table class="table">
	...
	<tr>
		...
		<td><textarea cols="70" rows="15" name="reContent" maxlength="128" required></textarea></td>
	</tr>
</table>
</div>
