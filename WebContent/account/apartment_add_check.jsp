...
<c:choose>
	...
	<div class="title_wrap">物件新規登録：確認・画像登録画面</div>

	<div id="table_common_wrap">
	<form id="apartmentupimage" action="apartmentupimage" method="post" enctype="multipart/form-data">
		<div class="table-responsive">
		<table class="table">
			<tr>
				<th>物件名</th>
				<td><pre><c:out value="${dto.apartmentName }"/></pre></td>
			</tr>
			<tr>
				<th>物件説明</th>
				<td><c:out value="${dto.apartmentDescription }"/></td>
			</tr>
			<tr>
				<th>入居可能人数</th>
				<td>
		...
		<div class="btn_2c">
		<p class="btn_custom"><button type="submit" class="btn btn-info" id="submit">登録</button></p>
	...
	<c:when test="${dto.apartmentImage == 'false' }">
	<div class="title_wrap">物件新規登録：確認画面</div>

	<div id="table_common_wrap">
	<form id="apartmentadd" action="apartmentadd" method="post">
		<div class="table-responsive">
		<table class="table">
			<tr>
				<th>物件名</th>
