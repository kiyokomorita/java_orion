...
<div class="title_wrap">口コミ新規登録：確認画面</div>

<div id="table_common_wrap">
<form id="review_add_input" action="reviewadd" method="post">
...
<table class="table">
	...
	<tr>
		<th>口コミ内容</th>
		<td><pre><c:out value="${dto.reviewContent }"/></pre></td>
	</tr>
</table>
</div>
